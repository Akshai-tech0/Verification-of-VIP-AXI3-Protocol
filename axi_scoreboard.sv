class axi_scoreboard extends uvm_scoreboard;
        ...
        uvm_tlm_analysis_fifo#(axi_transaction) mst_fifo_h[];
        uvm_tlm_analysis_fifo#(axi_transaction) slv_fifo_h[];

        axi_env_config env_cfg_h;
        axi_transaction wr_xtn,rd_xtn;
        axi_transaction mst_xtn,slv_xtn;
